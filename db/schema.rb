...
ActiveRecord::Schema[8.1].define(version: 2026_03_11_212130) do
  ...
  create_table "username_blocks", force: :cascade do |t|
    ...
    t.index ["normalized_username"], name: "index_username_blocks_on_normalized_username", opclass: :text_pattern_ops
  end
